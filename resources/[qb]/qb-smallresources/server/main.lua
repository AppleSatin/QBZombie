...
QBCore.Commands.Add("myrep", "Check Your Reputations", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)    
       if Player ~= nil then         
            ...
            TriggerClientEvent('chatMessage', source, "SYSTEM", "error", 'Crafting Rep: '..y..'')
            TriggerClientEvent('chatMessage', source, "SYSTEM", "error", 'Attachment Rep: '..z..'')   
      else     
       TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "Person not around")
    end
end)
